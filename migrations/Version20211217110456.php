 ...
 */
final class Version20211217110456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role_allow_section (role_id VARCHAR(25) NOT NULL, SectionId VARCHAR(255) NOT NULL, PRIMARY KEY(SectionId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE section (id VARCHAR(255) NOT NULL, server_id VARCHAR(25) NOT NULL, category_id VARCHAR(25) NOT NULL, creator_id VARCHAR(25) DEFAULT NULL, creator_name VARCHAR(25) NOT NULL, date DATETIME NOT NULL, name VARCHAR(25) NOT NULL, emoji VARCHAR(5) NOT NULL, visibility VARCHAR(10) NOT NULL, role_id VARCHAR(25) NOT NULL, announce_channel_id VARCHAR(25) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(25) NOT NULL, email VARCHAR(25) NOT NULL, avatar VARCHAR(30) NOT NULL, discord_id VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
